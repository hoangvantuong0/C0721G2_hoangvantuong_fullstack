    ...
    <form class="col-6  m-auto" method="post">
        ...
        <div class="form-group col-12">
            ...
            <input type="text" name="maMatBang" class="form-control col-12 float-left mt-2"
                   placeholder="nhập mã mặt bằng" value="${matbang.getMaMatBang()}">
            <%--      <p style="color: red">--%>
        ...
        <div class="form-group col-12">
            <label class="col-12 float-left mt-1">Trạng thái:</label>
            <select name="maTrangThai" class="form-control col-12 float-left">
                <option>Chose option ...</option>
                <c:forEach var="item" items="${trangThaiList}">
                    <option value="${item.getMaTrangThai()}"> ${item.getMaTrangThai()} - ${item.getTenTrangThai()} </option>
                </c:forEach>
            </select>
        </div>
        <div class="form-group col-12">
        ...
        <div class="form-group col-12">
            <label class="col-12 float-left mt-1">Loại mặt bằng:</label>
            <select name="maLoaiVanPhong" class="form-control col-12 float-left">
                <option>Chose option ...</option>
                <c:forEach var="item" items="${loaiVanPhongList}">
                    <option value="${item.maLoaiVanPhong}"> ${item.maLoaiVanPhong} - ${item.tenLoaiVanPhong} </option>
                </c:forEach>
            </select>
        </div>
        <div class="form-group col-12">
        ...
        <div class="form-group col-12">
            ...
            <input type="date" name="ngayBatDau" class="form-control col-12 float-left mt-2"
                   placeholder="Nhập ngày bắt đầu" value="${matbang.getNgayChoThue()}">
            <%--      <p style="color: red">--%>
        ...
        <div class="col-12 " style="padding: 2% 0%">
            ...
            <a href="/matbang">
                <button type="button" class="btn btn-info float-right">Trở về</button>
            </a>
        </div>
    </form>
</div>
<div class="col-12 bg-success m-auto text-light ">
    <div class="row">
        <div align="center">
            <p class="fs-6">Welcome to codeGym</p>
        </div>
    </div>
</div>
</div>
